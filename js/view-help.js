  ...
  function render(params, query, container) {
    ...
    section.appendChild(sec('about', 'このアプリでできること', [
      ...
      dl([
        ...
        ['教科書', ['教科書の定番教材 ' + idx.passages.length + ' 編を、' + idx.works.length + ' 作品ごとにまとめた入口。文章名をタップすると原文と現代語訳で読め、その文章に出てくる語だけで学習・クイズができます。作品名をタップすると、その作品の書誌・例文・収録語をまとめた作品ページに進みます。']],
